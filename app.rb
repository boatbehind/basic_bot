...
get "/sms/incoming" do
  ...
  if session["counter"] == 1
    ...
    message = "https://www.themoviedb.org/movie/379149-the-foreigner" + "vote average:6.3
    release year:2017"  + "cast:Jackie Chan, Pierce Brosnan, Charlie Murphy" +"overview:Quan is a humble London businessman whose long-buried past erupts in a revenge-fueled vendetta when the only person left for him to love -- his teenage daughter -- dies in a senseless act of politically motivated terrorism. His relentless search to find the terrorists leads to a cat-and-mouse conflict with a British government official whose own past may hold the clues to the identities of the elusive killers." + "This movie is on! Do you wanna see it?"
  elsif body == "yes"
